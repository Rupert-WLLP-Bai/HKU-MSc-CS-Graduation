...
\begin{center}
    \includegraphics[width=0.3\textwidth]{Covers/hkulogo_hb.jpg} % Include the university logo image
\end{center}
...
\begin{center}
    ...
    {Faculty of Engineering}\\[10pt] % Faculty name
...
\begin{center}
    ...
    {XXXXX}\\[20pt] % Placeholder for the actual title
\end{center}
...
\begin{center}
    {By\\
    XXX\\ % Replace with the student's name
    UID: XXX\\[10pt] % Replace with the student number
    
    Supervisor: Prof. XXXX\\ % Replace with the supervisor's title and name
    Date of submission: 01/04/2024} % Replace with the submission date
\end{center}
